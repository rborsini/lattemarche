    ...
    public partial class Aggiunta_V_Allevamenti_X_Giro : DbMigration
    {
        public override void Up()
        {
            ...
            string createQuery =    "SELECT        " +
                                    "   CAST(CAST(derivedtbl_1.ID_GIRO AS varchar(20)) + '' + CAST(derivedtbl_1.ID_ALLEVAMENTO AS varchar(20)) AS int) AS ID, " +
                                    "   derivedtbl_1.INDIRIZZO_ALLEVAMENTO, " +
                                    "   derivedtbl_1.ID_GIRO," +
                                    "   derivedtbl_1.ID_ALLEVAMENTO, " +
                                    "   dbo.COMUNI.DESCRIZIONE, " +
                                    "   dbo.COMUNI.PROVINCIA, " +
                                    "   dbo.UTENTI.NOME, " +
                                    "   dbo.UTENTI.COGNOME, " +
                                    "   dbo.UTENTI.RAGIONE_SOCIALE, " +
                                    "   dbo.ALLEVAMENTO_X_GIRO.PRIORITA" +
                                    "FROM" +
                                    "   (" +
                                    "       SELECT        " +
                                    ...
                                    "" +
                                    "   INNER JOIN" +
                                    "   dbo.ANAGRAFE_ALLEVAMENTO AS ANAGRAFE_ALLEVAMENTO_1 ON derivedtbl_1.ID_ALLEVAMENTO = ANAGRAFE_ALLEVAMENTO_1.ID_ALLEVAMENTO " +
                                    "" +
                                    "   INNER JOIN"+
                                    "   dbo.UTENTI ON ANAGRAFE_ALLEVAMENTO_1.ID_UTENTE = dbo.UTENTI.ID_UTENTE " +
                                    "" +
                                    "   INNER JOIN"+
                                    "   dbo.COMUNI ON ANAGRAFE_ALLEVAMENTO_1.ID_COMUNE = dbo.COMUNI.ID_COMUNE " +
                                    "" +
                                    "   LEFT OUTER JOIN"+
