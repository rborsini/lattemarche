namespace LatteMarche.EntityFramework.Migrations
{
    ...
    public partial class AggiuntaColonna_V_Prelievi_Tenant : DbMigration
    {
        private bool IsTestEnv => ConfigurationManager.ConnectionStrings["LatteMarcheDbContext"].ConnectionString.Contains("TEST") || ConfigurationManager.ConnectionStrings["LatteMarcheDbContext"].ConnectionString.Contains("(local)\\SQLEXPRESS");
        ...
        public override void Up()
        {
            ...
            if (!this.IsTestEnv)
            {
                Sql("DROP VIEW V_IntegrazioneCooperlat");

                Sql(@"	CREATE VIEW V_IntegrazioneCooperlat as 
					SELECT 
						prelievi.ID_PRELIEVO,
						prelievi.DATA_PRELIEVO,
						prelievi.DATA_CONSEGNA,
