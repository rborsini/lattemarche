    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button :disabled="cessionario.Piva === '' || cessionario.RagioneSociale === '' ||  cessionario.Indirizzo === '' || cessionario.SiglaProvincia === '' || cessionario.IdComune == 0" class="btn btn-primary" v-on:click="onSave()">Salva</button>
        </div>
      </div>
    </div>
  </div>
