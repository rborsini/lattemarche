<template>
  <div>
    ...
    <notification-dialog
      ...
      v-on:ok="window.location = '/trasportatori'"
    ></notification-dialog>
    ...
    <giro-trasportatori-modal ref="giroTrasportatoriModal" :giro="giro"></giro-trasportatori-modal>
...
export default class TrasportatoriEditPage extends Vue {
  ...
  public loadTrasportatori() {
    this.trasportatoriService.getTrasportatori().then(response => {
  ...
  public onTrasportatoreSelezionato(idTrasportatore: string): void {
    ...
    this.trasportatoriService
      .getTrasportatoreDetails(idTrasportatore)
      .then(response => {
