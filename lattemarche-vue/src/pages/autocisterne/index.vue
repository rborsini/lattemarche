...
export default class AutocisterneIndexPage extends Vue {
  ...
  public mounted() {
    ...
    this.initTable();
    this.autocisterneService.index().then(response => {
  ...
  public onDataLoaded() {
    $(".edit").click(event => {
      ...
      this.autocisterneService.details(rowId).then(response => {
  ...
  public onRemove() {
    this.autocisterneService.delete(this.idAutocisterna).then(response => {
