...
export default class AnalisiLatteIndexPage extends Vue {
  ...
  private initSearchBox() {
    ...
    this.params.DataPeriodoFine_Str = DateService.formatDate(new Date());
    this.params.DataPeriodoInizio_Str = DateService.formatDate(
      DateService.subtractMonth(new Date())
    );
