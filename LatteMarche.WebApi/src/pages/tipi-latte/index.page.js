function TabellaTipiLatte() {

    var url = apiUrl + 'tipilatte';

    var table = $('#tipi-latte-table').dataTable({
        ...
        columns: [
            ...
            { "data": "FattoreConversione" },
            {
                "data": null,
                "render": function (data, type, row) {
                    return '<a class="edit" href="' + webUrl + 'tipilatte/edit?id=' + row.Id + '" >Dettagli</a>';
                }
            }
        ]
    });
